 ...
 * @returns
 */
export const addOrUpdataArrt = (data: Attr) => request.post<any, any>(API.ADDORUPDATAATTR_URL, data)
 ...
 * @returns
 */
export const reqDeleteAttr = (attrId: number) => request.delete(API.ATTRDELETE_URL + attrId)
