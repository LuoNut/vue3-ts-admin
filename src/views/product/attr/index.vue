<template>
  ...
  <el-card style="margin: 10px 0">
    <div v-show="scene === 0">
      <el-button type="primary" icon="Plus" :disabled="CategoryStore.c3Id ? false : true" @click="addAttr" v-has="`btn.Attr.add`">
        添加属性
      </el-button>
    ...
    <div v-show="scene === 1">
      ...
      <el-button type="primary" icon="Plus" :disabled="!attrParam.attrName" @click="addAttrValue" v-has="`btn.Attr.update`">
        添加属性
      </el-button>
